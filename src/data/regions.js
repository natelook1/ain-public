// EVE Online Regions Data - Built from ESI API
// Grouped by empire/space type for easier selection
...
export const ALL_REGIONS = Object.values(REGION_GROUPS).flat()

// Map for quick lookup by ID
export const REGION_BY_ID = Object.fromEntries(ALL_REGIONS.map(r => [r.id, r]))

// Map for quick lookup by name (lowercase)
export const REGION_BY_NAME = Object.fromEntries(ALL_REGIONS.map(r => [r.name.toLowerCase(), r]))

export default { REGION_GROUPS, ALL_REGIONS, REGION_BY_ID, REGION_BY_NAME }
